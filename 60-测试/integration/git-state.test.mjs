import assert from 'node:assert/strict';import fs from 'node:fs';import path from 'node:path';import test from 'node:test';import { captureBaseline,computeChangeSet,normalizeScope,assertChangeSetWithinScope,userChangesRemainIsolated } from '../../40-脚本/lib/git-state.mjs';import { gitRepo,tempDir } from '../helpers.mjs';
